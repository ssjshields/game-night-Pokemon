...
Pokemon.tradingCards = {
   ...
   "Jungle Wigglytuff"
    ...
    "Rocket Challenge",
    "Rocket Charmander",
    "Rocket Dark Alakazam (Alt)",
    "Rocket Dark Alakazam",
    "Rocket Dark Arbok (Alt)",
    "Rocket Dark Arbok",
    "Rocket Dark Blastoise (Alt)",
    "Rocket Dark Blastoise",
    "Rocket Dark Charizard (Alt)",
    "Rocket Dark Charizard",
    "Rocket Dark Charmeleon",
    "Rocket Dark Dragonair",
    "Rocket Dark Dragonite (Alt)",
    "Rocket Dark Dragonite",
    "Rocket Dark Dugtrio (Alt)",
    "Rocket Dark Dugtrio",
    "Rocket Dark Electrode",
    "Rocket Dark Flareon",
    "Rocket Dark Gloom",
    "Rocket Dark Golbat (Alt)",
    "Rocket Dark Golbat",
    "Rocket Dark Golduck",
    "Rocket Dark Gyarados (Alt)",
    "Rocket Dark Gyarados",
    "Rocket Dark Hypno (Alt)",
    "Rocket Dark Hypno",
    "Rocket Dark Jolteon",
    "Rocket Dark Kadabra",
    "Rocket Dark Machamp (Alt)",
    "Rocket Dark Machamp",
    "Rocket Dark Machoke",
    "Rocket Dark Magneton (Alt)",
    "Rocket Dark Magneton",
    "Rocket Dark Muk",
    "Rocket Dark Persian",
    "Rocket Dark Primeape",
    "Rocket Dark Raichu",
    "Rocket Dark Rapidash",
    "Rocket Dark Raticate",
    "Rocket Dark Slowbro (Alt)",
    "Rocket Dark Slowbro",
    "Rocket Dark Vaporeon",
    "Rocket Dark Vileplume (Alt)",
    "Rocket Dark Vileplume",
    "Rocket Dark Wartortle",
    "Rocket Dark Weezing (Alt)",
    "Rocket Dark Weezing",
    "Rocket Digger",
    "Rocket Diglett",
    "Rocket Dratini",
    ...
    "Rocket Ekans",
    "Rocket filename",
    "Rocket Full Heal Energy",
    "Rocket Goop Gas Attack",
    "Rocket Grimer",
    "Rocket Here Comes Team Rocket (Alt)",
    "Rocket Here Comes Team Rocket",
    "Rocket Imposter Oaks Revenge",
    "Rocket Koffing",
    "Rocket Machop",
    "Rocket Magikarp",
    "Rocket Magnemite",
    "Rocket Mankey",
    "Rocket Meowth",
    "Rocket Nightly Garbage Run",
    "Rocket Oddish",
    "Rocket Ponyta",
    "Rocket Porygon",
    "Rocket Potion Energy",
    "Rocket Psyduck",
    "Rocket Rainbow Energy (Alt)",
    "Rocket Rainbow Energy",
    "Rocket Rattata",
    "Rocket Rockets Sneak Attack (Alt)",
    "Rocket Rockets Sneak Attack",
    "Rocket Sleep",
    "Rocket Slowpoke",
    "Rocket Squirtle",
    "Rocket The Bosss Way",
    "Rocket Voltorb",
    "Rocket Zubat",
    },
